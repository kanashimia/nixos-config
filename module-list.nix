...
{ lib, nixpkgs, ... }:
let
  m = "${nixpkgs}/nixos/modules/";
in
{
  # documentation doesn't work at the moment
  documentation.enable = lib.mkForce false;
  imports = map (p: m + (lib.removePrefix "nixos/modules" p)) [
  ...
  ] ++ [
    {
      ...
      options.services.displayManager.gdm.enable = lib.mkEnableOption "";
      # "nixos/modules/services/x11/display-managers/xpra.nix"
      options.services.xserver.displayManager.xpra.enable = lib.mkEnableOption "";
      # "nixos/modules/services/display-managers/ly.nix"
      options.services.displayManager.ly.enable = lib.mkEnableOption "";
      # "nixos/modules/services/display-managers/lemurs.nix"
      options.services.displayManager.lemurs.enable = lib.mkEnableOption "";
      # "nixos/modules/services/desktops/gnome/gnome-software.nix"
      options.services.gnome.gnome-software.enable = lib.mkEnableOption "";
      # "./services/desktops/gnome/at-spi2-core.nix"
      # "./services/desktops/gnome/evolution-data-server.nix"
      # "./services/desktops/gnome/glib-networking.nix"
      # "./services/desktops/gnome/gnome-browser-connector.nix"
      ...
      # "./services/desktops/gnome/sushi.nix"
      # "./services/desktops/gnome/tinysparql.nix"
      options.services.gnome.at-spi2-core.enable = lib.mkEnableOption "";
      options.services.gnome.evolution-data-server.enable = lib.mkEnableOption "";
      options.services.gnome.evolution-data-server.plugins = lib.mkOption { default = []; };
      options.services.gnome.glib-networking.enable = lib.mkEnableOption "";
      options.services.gnome.gnome-browser-connector.enable = lib.mkEnableOption "";
      options.services.gnome.gnome-initial-setup.enable = lib.mkEnableOption "";
      options.services.gnome.gnome-keyring.enable = lib.mkEnableOption "";
      options.services.gnome.gnome-remote-desktop.enable = lib.mkEnableOption "";
      options.services.gnome.gnome-online-accounts.enable = lib.mkEnableOption "";
      options.services.gnome.gnome-settings-daemon.enable = lib.mkEnableOption "";
      options.services.gnome.gnome-user-share.enable = lib.mkEnableOption "";
      options.services.gnome.localsearch.enable = lib.mkEnableOption "";
      options.services.gnome.rygel.enable = lib.mkEnableOption "";
      options.services.gnome.sushi.enable = lib.mkEnableOption "";
      options.services.gnome.tinysparql.enable = lib.mkEnableOption "";
      # "./services/desktops/blueman.nix"
      options.services.blueman.enable = lib.mkEnableOption "";
      # "./services/desktops/dleyna.nix"
      # "./services/desktops/geoclue2.nix"
      options.services.dleyna.enable = lib.mkEnableOption "";
      options.services.geoclue2.enable = lib.mkEnableOption "";
      options.services.geoclue2.appConfig = lib.mkOption { default = {}; };
      options.services.geoclue2.enableDemoAgent = lib.mkEnableOption "";
      options.services.geoclue2.whitelistedAgents = lib.mkOption { default = []; };
